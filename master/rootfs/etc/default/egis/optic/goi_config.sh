...
Table_Pth_corr="goi_table_pth_corr.csv" # file name of Pth correction table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
Table_LaserRef="goi_table_laser_ref.csv" # file name of laser reference table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
Table_LaserRef_base="goi_table_laser_ref_base.csv" # file name of laser reference base table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
Table_MPDresp_corr="goi_table_mpd_resp_corr.csv" # file name of MSP response correction table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
Table_TempTrans_ext="goi_table_text_corr.csv" # file name of temperature translation table (nominal->corrected) (TableTemp_ExtNom_Min - TableTemp_ExtNom_Max)
Table_RSSI1490_corr="goi_table_rssi1490_corr.csv" # file name of RSSI 1490 correction table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
Table_RSSI1550_corr="goi_table_rssi1550_corr.csv" # file name of RSSI 1550 correction table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
Table_RF1550_corr="goi_table_rf1550_corr.csv" # file name of RF 1550 correction table (TableTemp_ExtCorr_Min - TableTemp_ExtCorr_Max)
LaserAgeFile="goi_age" # file for current timestamp / laser age in seconds
...
$VAPD_ext_inductivity $VAPD_ext_supply $VAPD_efficiency $VAPD_current_limit \
